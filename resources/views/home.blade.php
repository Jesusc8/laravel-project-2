...
@section('content')
    <div class="bg-gray-900 p-20 py-16 rounded-lg mb-8 relative overflow-hidden" >
        ...
        <div class="grid grid-cols-1 gap-4 mb-4">
            ...
            <a href="{{ route('post', $post->slug) }}" class="bg-gray-100 rounded-lg px-6 py-4">
                ...
                <div class="text-xs text-gray-900 opacity-75 flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" className="size-6">
